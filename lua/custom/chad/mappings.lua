...
M.general = {
    ...
    v = {
        ...
        ["<leader>ti"] = { "c<C-r>=strftime('%Y-%m-%d %H:%M:%S')<C-m><C-c>", "Insert time", opts = nowait },
...
M.telescope = {
    n = {
        ...
        ["<C-Space>"] = { "<CMD>Telescope find_files hidden=true no_ignore=false<CR>", "Find unignored files" },
...
M.coc = {
    n = {
        ...
        ["<leader>tl"] = { "<CMD>CocCommand coc-todo-tree.showTree<CR>", "Show todo list", opts = nowait },
